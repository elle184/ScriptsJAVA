 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://impl.ws.soloenbinario.com/", wsdlLocation = "http://localhost:8080/SoapWebService/HelloWorldImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://impl.ws.soloenbinario.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SoapWebService/HelloWorldImpl?wsdl");
    ...
    public IHelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://impl.ws.soloenbinario.com/", "HelloWorldImplPort"), IHelloWorld.class);
    }
    ...
    public IHelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.ws.soloenbinario.com/", "HelloWorldImplPort"), IHelloWorld.class, features);
    }
